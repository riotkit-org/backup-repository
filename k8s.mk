...
k8s_test_backup_repository:
	helm upgrade --install backup-repository ./helm/backup-repository-server -n backup-repository --values ./helm/examples/backup-repository-ci.values.yaml --wait --timeout 30s --set image.repository=${IMAGE_REPOSITORY} --set image.tag=${IMAGE_TAG}
