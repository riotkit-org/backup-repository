<?php  //[STAMP] 8994cc0ea1cf51840343ec9c06c374fb
...
trait FunctionalTesterActions
{
    ...
    public function storeIdAs(string $path, string $nameInStore): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('storeIdAs', func_get_args()));
    }
    ...
    public function store(string $value, string $nameInStore): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('store', func_get_args()));
    }
    ...
    public function deleteFromStore(string $nameInStore): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('deleteFromStore', func_get_args()));
    }
