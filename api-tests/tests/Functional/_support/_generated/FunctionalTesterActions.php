<?php  //[STAMP] 48a48ba53585b99b098cec86cdb9d9c4
...
trait FunctionalTesterActions
{
     ...
     * @see \Helper\ApiTester::storeIdAs()
     */
    public function storeIdAs($path, $nameInStore) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('storeIdAs', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\ApiTester::store()
     */
    public function store($value, $nameInStore) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('store', func_get_args()));
    }
     ...
     *
     * @return null|string
     * @see \Helper\ApiTester::getPreviouslyStoredIdOf()
     */
    public function getPreviouslyStoredIdOf($nameInStore, $raiseException = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getPreviouslyStoredIdOf', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\ApiTester::deleteFromStore()
     */
    public function deleteFromStore($nameInStore) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('deleteFromStore', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\ApiTester::fill()
     */
    public function fill($url, $vars) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('fill', func_get_args()));
    }
}
